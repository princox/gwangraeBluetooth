package sensor.hlab.gwangraebluetooth.BLE;
...
import sensor.hlab.gwangraebluetooth.MainActivity;
import sensor.hlab.gwangraebluetooth.R;
...
//    public static final String SerialPortUUID="0000dfb1-0000-1000-8000-00805f9b34fb";
    ...
    public static final String SerialPortUUID="00002a37-0000-1000-8000-00805f9b34fb";
    public static final String CommandUUID= "6c722a0a-5bf1-4f64-9170-381c08ec57ee";
        ...
        mScanDeviceDialog = new AlertDialog.Builder(mainContext)
                .setTitle("BLE Device Scan...").setAdapter(mLeDeviceListAdapter, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which)
                    {
                        ...
                        if (device == null)
                            return;
                        Log.d(TAG, "### mScanDeviceDialog 내부임.");
                        scanLeDevice(false);
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                Log.d("블루투스 서비스 : ",action);
                if(mSCharacteristic == mModelNumberCharacteristic)
                {
                    String i = intent.getStringExtra(BluetoothLeService.EXTRA_DATA).toUpperCase();
                    if ( i == null ) {
                        Log.d("블루투스 서비스 : ", i);
                    } else {
                        Log.d("블루투스 서비스 : not null -> ", i);
                    }
                    if (intent.getStringExtra(BluetoothLeService.EXTRA_DATA).toUpperCase().startsWith("FUSE")) {
...
//                        mBluetoothLeService.writeCharacteristic(mSCharacteristic);\
//                        Log.d("mSerialPortCharacteristic : ", mSerialPortCharacteristic);
                        ...
                        Toast.makeText(mainContext, "Please select DFRobot devices 222",Toast.LENGTH_SHORT).show();
                        mConnectionState = connectionStateEnum.isToScan;
                        onConectionStateChange(mConnectionState);
                    }
                }
                else if (mSCharacteristic==mSerialPortCharacteristic) {
                    Log.d("received message : ## ", intent.getStringExtra(BluetoothLeService.EXTRA_DATA));
                    Intent intent2 = new Intent(BlunoLibrary.this, MainActivity.class);
                    intent.putExtra("HeartRate", intent.getStringExtra(BluetoothLeService.EXTRA_DATA));
